...
Plans:
- [ ] 05.2-01-PLAN.md — Baseline persona + overlay framework (TDD, Wave 1)
- [ ] 05.2-02-PLAN.md — silence-monitor state-machine rewire D-7 (TDD, Wave 1)
- [ ] 05.2-03-PLAN.md — Outbound wait-for-speech + nudge ladder D-8 (TDD, Wave 2)
- [ ] 05.2-04-PLAN.md — Case-2 task-overlay migration + Case-6b overlay extract (TDD, Wave 2)
