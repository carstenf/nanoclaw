...
Plans:
- [ ] 05.6-01-PLAN.md — Wave 1 — Real defaultInvokeAgent + defaultInvokeAgentTurn via container-runner integration; voice-personas skill consumed; Du/Sie derivation in agent; live-cutover-synth.test.ts (REQ-DIR-06/11/12/14/16/17/VOICE-13 — code-only)
