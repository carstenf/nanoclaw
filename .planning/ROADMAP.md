...
Plans:
- [ ] 05.3-01-PLAN.md — Wave 1 — Delete 3 dead exports (CASE2_TOLERANCE/HOLD_MUSIC blocks + INVALID_TOOL_RESPONSE unused import) — D-1
- [ ] 05.3-03-PLAN.md — Wave 2 — CASE6B_PERSONA → baseline + case_6b_inbound_carsten overlay webhook.ts rewire + const delete — D-2 (depends on 01)
- [ ] 05.3-04-PLAN.md — Wave 3 — Research deliverable: idle-timeout-finding.md answering D-4 Q1-Q4 + silence-monitor disposition verdict (autonomous: false) (depends on 03)
